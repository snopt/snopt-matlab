function [x,F,inform,xmul,Fmul] = snsolve( x, xlow, xupp, xmul, xstate,...
					   Flow, Fupp, Fmul, Fstate,...
					   userfun, varargin );
% [x,F,inform,xmul,Fmul] = snsolve( x, xlow, xupp, xmul, xstate, ...
%                                   Flow, Fupp, Fmul, Fstate, ...
%                                   userfun,varargin );
%
...
%      jGvar, then snsolve() will determine them by calling snJac().
%
